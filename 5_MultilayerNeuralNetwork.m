...
%=========================================================================%
% Consider three-layer neural network: 
...
%=========================================================================%
% CAUTION
% For linearly non-separable and skewed linearly separable data, 
% I could not draw the decision boundary well...

% Grid
xx = -1.5 : 0.001 : 1.5; yy = -1.5 : 0.001 : 1.5;

% Coordinates of decision boundary
db = [];
counter2 = 0;

% Extract the coordinates of decision boundary
for i = 1 : length(xx)
    for j = 1 : length(yy)
        ...
        % Extract coordinates (xx,yy) where g_out is around 0.5
...
plot(db(:, 1), db(:, 2), 'k');                                % Plot decision boundary
xlim([-1.5, 1.5])
ylim([-1.5, 1.5])
switch choice
    case 1 
